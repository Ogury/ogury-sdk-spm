...
#import "OGAJSONValueTransformer.h"
#import "OGAJSONKeyMapper.h"
 ...
 */
@protocol OGAAbstractJSONModelProtocol <NSCopying, NSCoding>
 ...
 */
@interface OGAJSONModel : NSObject <OGAAbstractJSONModelProtocol, NSSecureCoding>
...
+ (void)setGlobalKeyMapper:(OGAJSONKeyMapper *)globalKeyMapper DEPRECATED_MSG_ATTRIBUTE("override +keyMapper in a base model class instead");
 ...
 */
- (instancetype)initWithString:(NSString *)string error:(OGAJSONModelError **)err;
 ...
 * or a property type in your model is not supported by JSONValueTransformer and its categories
 */
- (instancetype)initWithString:(NSString *)string usingEncoding:(NSStringEncoding)encoding error:(OGAJSONModelError **)err;
