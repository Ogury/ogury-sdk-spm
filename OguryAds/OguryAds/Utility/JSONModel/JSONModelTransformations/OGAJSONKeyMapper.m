...
@implementation OGAJSONKeyMapper
...
- (instancetype)initWithDictionary:(NSDictionary *)map {
    NSDictionary *toJSON = [OGAJSONKeyMapper swapKeysAndValuesInDictionary:map];
...
+ (instancetype)mapper:(OGAJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions {
    NSDictionary *toJSON = [OGAJSONKeyMapper swapKeysAndValuesInDictionary:exceptions];

    return [self baseMapper:baseKeyMapper withModelToJSONExceptions:toJSON];
}

+ (instancetype)baseMapper:(OGAJSONKeyMapper *)baseKeyMapper withModelToJSONExceptions:(NSDictionary *)toJSON {
    return [[self alloc] initWithModelToJSONBlock:^NSString *(NSString *keyName) {
        if (!keyName)
            return nil;
