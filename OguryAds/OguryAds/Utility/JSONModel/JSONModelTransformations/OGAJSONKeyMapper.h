 ...
 * </pre>
 */
@interface OGAJSONKeyMapper : NSObject
...
+ (instancetype)mapper:(OGAJSONKeyMapper *)baseKeyMapper withExceptions:(NSDictionary *)exceptions DEPRECATED_MSG_ATTRIBUTE("use baseMapper:withModelToJSONExceptions:");
