...
extern BOOL OGAisNull(id value) {
    if (!value) return YES;
...
@implementation OGAJSONValueTransformer

- (id)init {
    self = [super init];
    if (self) {
        _primitivesNames = @{@"f" : @"float", @"i" : @"int", @"d" : @"double", @"l" : @"long", @"B" : @"BOOL", @"s" : @"short", @"I" : @"unsigned int", @"L" : @"usigned long", @"q" : @"long long", @"Q" : @"unsigned long long", @"S" : @"unsigned short", @"c" : @"char", @"C" : @"unsigned char",
...
- (NSNumber *)BOOLFromNSNumber:(NSNumber *)number {
    if (OGAisNull(number)) return [NSNumber numberWithBool:NO];
