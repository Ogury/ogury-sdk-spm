...
/////////////////////////////////////////////////////////////////////////////////////////////
typedef NS_ENUM(int, kOGAJSONModelErrorTypes) {
    kOGAJSONModelErrorInvalidData = 1,
    kOGAJSONModelErrorBadResponse = 2,
    kOGAJSONModelErrorBadJSON = 3,
    kOGAJSONModelErrorModelIsInvalid = 4,
    kOGAJSONModelErrorNilInput = 5
};

/////////////////////////////////////////////////////////////////////////////////////////////
/** The domain name used for the JSONModelError instances */
extern NSString *const OGAJSONModelErrorDomain;
 ...
 */
extern NSString *const kOGAJSONModelMissingKeys;
 ...
 */
extern NSString *const kOGAJSONModelTypeMismatch;
 ...
 */
extern NSString *const kOGAJSONModelKeyPath;
 ...
 */
@interface OGAJSONModelError : NSError
