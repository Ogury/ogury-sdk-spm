...
@property(nonatomic, readonly) OGAOrderedDictionary *root;

- (instancetype)initWithData:(NSData *)data root:(OGAOrderedDictionary *)root;

@end

@implementation OGAOrderedDictionary {
   @protected
    NSArray *_values;
    NSOrderedSet *_keys;
}
...
- (instancetype)init {
    if ((self = [super init]) && [self class] == [OGAOrderedDictionary class]) {
        static OGAOrderedDictionary *singleton;
...
- (instancetype)mutableCopyWithZone:(NSZone *)zone {
    return [[OGAMutableOrderedDictionary allocWithZone:zone] initWithDictionary:self];
}
...
@implementation OGAMutableOrderedDictionary
...
+ (instancetype)dictionaryWithCapacity:(NSUInteger)count {
    return [(OGAMutableOrderedDictionary *)[self alloc] initWithCapacity:count];
}
...
- (id)copyWithZone:(NSZone *)zone {
    return [[OGAOrderedDictionary allocWithZone:zone] initWithDictionary:self];
}
...
- (void)sort {
    OGAMutableOrderedDictionary *copy = [self copy];
...
- (instancetype)initWithData:(NSData *)data root:(OGAOrderedDictionary *)root {
    if ((self = [super init])) {
        _root = [root isKindOfClass:[OGAMutableOrderedDictionary class]] ? root : nil;
...
- (void)parser:(NSXMLParser *)parser didStartElement:(nonnull NSString *)elementName namespaceURI:(__unused NSString *)namespaceURI qualifiedName:(__unused NSString *)qName attributes:(__unused NSDictionary<NSString *, NSString *> *)attributeDict {
    if ([elementName isEqualToString:@"dict"]) {
        if (_valueStack == nil) {
            _valueStack = [NSMutableArray arrayWithObject:_root ?: [OGAMutableOrderedDictionary dictionary]];
        } else {
            [_valueStack addObject:[OGAMutableOrderedDictionary dictionary]];
        }
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(__unused NSString *)namespaceURI qualifiedName:(__unused NSString *)qName {
    ...
    if ([top isKindOfClass:[OGAMutableOrderedDictionary class]]) {
        NSString *key = _keyStack.lastObject;
        ((OGAMutableOrderedDictionary *)top)[key] = value;
