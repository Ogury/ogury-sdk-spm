 ...
 */
@interface OGAOrderedDictionary<__covariant KeyType, __covariant ObjectType> : NSDictionary <KeyType, ObjectType>
 ...
 */
@interface OGAMutableOrderedDictionary<KeyType, ObjectType> : OGAOrderedDictionary <KeyType, ObjectType>
