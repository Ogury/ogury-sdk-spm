...
@implementation OGAInterstitialAdInternalAPI
...
- (instancetype)initWithAdUnitId:(NSString *)adUnitId
    ...
    if (self = [super init]) {
        ...
        @weakify(self) _configuration = [[OGAAdConfiguration alloc] initWithType:OguryAdsTypeInterstitial
                                                                        adUnitId:adUnitId
                                                              delegateDispatcher:delegateDispatcher
...
- (void)loadWithAdMarkup:(NSString *)adMarkup {
    [self.log logAdFormat:OguryLogLevelInfo forAdConfiguration:self.configuration format:@"loadWithAdMarkup called with AdMarkup [%@]", adMarkup];
