...
#define oga_onExit                  \
    ext_keywordify                  \
        __strong ext_cleanupBlock_t \
        metamacro_concat(ext_exitBlock_, __LINE__) __attribute__((cleanup(oga_ext_executeCleanupBlock), unused)) = ^
...
extern "C" {
#endif
void oga_ext_executeCleanupBlock(__strong ext_cleanupBlock_t *block);
#if defined(__cplusplus)
}
#endif
