...
- (void)testLoadInit300x250 {
    ...
    [self.internalAPI loadWithSize:[OguryAdsBannerSize mrec_300x250]];

    XCTAssertTrue(CGSizeEqualToSize([self.internalAPI.size getSize], [[OguryAdsBannerSize mrec_300x250] getSize]));
    XCTAssertTrue(CGSizeEqualToSize(self.internalAPI.configuration.size, [[OguryAdsBannerSize mrec_300x250] getSize]));
}
...
- (void)testShouldLoadWithCampaign {
    ...
    OCMStub(self.internal.sdkInitialized).andReturn(YES);
    [self.internalAPI loadWithCampaignId:DefaultCampaignId size:[OguryAdsBannerSize mrec_300x250]];
...
- (void)testShouldLoadWithCampaignCreativeId {
    ...
    [self.internalAPI loadWithCampaignId:DefaultCampaignId creativeId:DefaultCreativeId size:[OguryAdsBannerSize mrec_300x250]];
...
- (void)testShouldLoadWithCampaignCreativeIdDspCreativeIdDspRegion {
    ...
    [self.internalAPI loadWithCampaignId:DefaultCampaignId creativeId:DefaultCreativeId dspCreativeId:DefaultDspCreativeId dspRegion:DefaultDspRegion size:[OguryAdsBannerSize mrec_300x250]];
...
- (void)testLoadWithCampaignIdCreativeId {
    ...
    [self.internalAPI loadWithCampaignId:@"campaignId" creativeId:@"creativeId" size:[OguryAdsBannerSize mrec_300x250]];
    ...
    XCTAssertEqual(self.internalAPI.size.getSize.width, [OguryAdsBannerSize mrec_300x250].getSize.width);
    XCTAssertEqual(self.internalAPI.size.getSize.height, [OguryAdsBannerSize mrec_300x250].getSize.height);
    XCTAssertEqual(self.internalAPI.configuration.size.width, [OguryAdsBannerSize mrec_300x250].getSize.width);
    XCTAssertEqual(self.internalAPI.configuration.size.height, [OguryAdsBannerSize mrec_300x250].getSize.height);
    XCTAssertEqual(self.internalAPI.sequence, sequence);
}
