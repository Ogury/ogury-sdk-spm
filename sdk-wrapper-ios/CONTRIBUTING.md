...
Before performing any release, it is mandatory to update the marketing version and the bundle version located in the `OguryWrapper/Configurations/Configuration.xcconfig` file.
