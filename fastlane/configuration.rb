class Configuration
  ...
  def initialize
    ...
    @frameworks.ogury_core = Framework.new("2.1.0-rc.3", "2.0.0", "2.0.0")
    @frameworks.ogury_ads = Framework.new("4.1.0-rc.3", "4.0.0", "4.0.0")
    @frameworks.ogury_sdk = Framework.new("5.1.0-rc.3", "5.0.0", "5.0.0")
