class Configuration
  ...
  def initialize
    ...
    @frameworks.ogury_core = Framework.new("2.2.0-rc.2", "2.1.0", "2.1.0")
    @frameworks.ogury_ads = Framework.new("4.2.0-rc.5", "4.1.0", "4.1.1")
    @frameworks.ogury_sdk = Framework.new("5.2.0-rc.5", "5.1.0", "5.1.1")
