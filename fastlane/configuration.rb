class Configuration
  ...
  def initialize
    ...
    @frameworks.ogury_core = Framework.new("2.2.0-rc.1", "2.1.0", "2.1.0")
    @frameworks.ogury_ads = Framework.new("4.2.0-rc.3", "4.1.0", "4.1.1")
    @frameworks.ogury_sdk = Framework.new("5.2.0-rc.3", "5.1.0", "5.1.1")
