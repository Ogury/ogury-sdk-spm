class Configuration
  ...
  def initialize
    ...
    internalRepositories = Repositories.new(Repository.new("binaries.ogury.co/internal/"), Repository.new("Ogury/sdk-internal-cocoapods"), Repository.new("https://github.com/Ogury/sdk-internal-spm"))
    publicRepositories = Repositories.new(Repository.new("binaries.ogury.co"), Repository.new("https://cdn.cocoapods.org/"), Repository.new("https://github.com/Ogury/ogury-sdk-spm"))
